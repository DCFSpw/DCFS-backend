...
//
// params:
//   - err - validation error object generated by JSON binding function
//
// return type:
//   - response: ValidationErrorResponse with list of validation errors
...
//   - field: string with name of the invalid field
//   - message - string with error message
//
// return type:
//   - response: ValidationErrorResponse with single error
